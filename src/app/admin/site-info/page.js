  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-xs text-muted mt-1">Edit the About section, hero text, and contact details.</p>
      </div>
      ...
      <div className="bg-[#160d08] border border-[rgba(217,169,70,0.18)] rounded-xl p-6 max-w-3xl">
        <form onSubmit={handleSave} className="space-y-5">
          <div>
            ...
            <textarea rows={4} required value={data.about || ""} onChange={(e) => setData({ ...data, about: e.target.value })} className="w-full bg-[#0c0704] border border-[rgba(217,169,70,0.25)] rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-gold" />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs text-[#cfc0ab] mb-1 font-medium">Hero Subtitle (English)</label>
              <input type="text" value={data.heroTaglineEn || ""} onChange={(e) => setData({ ...data, heroTaglineEn: e.target.value })} className="w-full bg-[#0c0704] border border-[rgba(217,169,70,0.25)] rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-gold" />
            </div>
            <div>
              <label className="block text-xs text-[#cfc0ab] mb-1 font-medium">Hero Subtitle (Kannada)</label>
              <input type="text" value={data.heroTaglineKn || ""} onChange={(e) => setData({ ...data, heroTaglineKn: e.target.value })} className="w-full bg-[#0c0704] border border-[rgba(217,169,70,0.25)] rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-gold" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <textarea rows={3} value={data.heroCopyEn || ""} onChange={(e) => setData({ ...data, heroCopyEn: e.target.value })} className="w-full bg-[#0c0704] border border-[rgba(217,169,70,0.25)] rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-gold" />
            </div>
            <div>
              <label className="block text-xs text-[#cfc0ab] mb-1 font-medium">Hero Description (Kannada)</label>
              <textarea rows={3} value={data.heroCopyKn || ""} onChange={(e) => setData({ ...data, heroCopyKn: e.target.value })} className="w-full bg-[#0c0704] border border-[rgba(217,169,70,0.25)] rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-gold" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
            <div>
              ...
              <input type="text" value={data.contactPhone || ""} onChange={(e) => setData({ ...data, contactPhone: e.target.value })} className="w-full bg-[#0c0704] border border-[rgba(217,169,70,0.25)] rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-gold" />
            </div>
            <div>
              <label className="block text-xs text-[#cfc0ab] mb-1 font-medium">Contact Email</label>
              <input type="email" value={data.contactEmail || ""} onChange={(e) => setData({ ...data, contactEmail: e.target.value })} className="w-full bg-[#0c0704] border border-[rgba(217,169,70,0.25)] rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-gold" />
            </div>
          </div>
