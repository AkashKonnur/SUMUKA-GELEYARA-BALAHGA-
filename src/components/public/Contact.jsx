        ...
        <ScrollReveal delay={0.15}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-[900px] mx-auto">
            ...
            <div className="bg-[rgba(255,255,255,0.03)] border border-[rgba(217,169,70,0.2)] rounded-2xl p-6 text-center hover:border-gold transition-all duration-300">
              ...
              <h3 className="font-[var(--font-heading)] text-gold-light text-base mb-1">
                {data.contactName || "Kiran"}
              </h3>
              <p className="text-[#e2d5c2] text-sm font-mono">{data.contactPhone || "+91 77956 76274"}</p>
            ...
            <div className="bg-[rgba(255,255,255,0.03)] border border-[rgba(217,169,70,0.2)] rounded-2xl p-6 text-center hover:border-gold transition-all duration-300">
              <span className="text-3xl block mb-3">📞</span>
              <h3 className="font-[var(--font-heading)] text-gold-light text-base mb-1">
                {data.contact2Name || "Sagar"}
              </h3>
              <p className="text-[#e2d5c2] text-sm font-mono">{data.contact2Phone || "+91 88929 83068"}</p>
              <p className="text-[#968673] text-[0.75rem] mt-2">Available 9:00 AM – 9:00 PM</p>
            </div>
